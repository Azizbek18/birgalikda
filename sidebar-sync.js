...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function iconMarkup(item) {
        return `<img class="menu-svg-icon" src="./rasmlar/${item.icon}" alt="" aria-hidden="true" onerror="this.style.display='none';this.nextElementSibling.style.display='inline-flex';"><i class="fa-solid ${item.fa}" style="display:none"></i>`;
    }
        ...
        return `
            ...
            <div>
                ...
                <div class="user-welcome">
                    <img src="rasmlar/Foydalanuvchi rasmi (1).png" alt="Avatar" class="user-avatar">
                    <div>
    ...
    function syncUserState() {
        ...
        if (sidebarAvatar) sidebarAvatar.src = currentUser.avatar_url || 'rasmlar/Foydalanuvchi rasmi (1).png';
